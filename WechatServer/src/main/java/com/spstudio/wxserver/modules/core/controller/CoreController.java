package com.spstudio.wxserver.modules.core.controller;
...
public class CoreController extends WxBaseController {
    ...
    @Autowired
    protected WxRouteService coreService;
     ...
     * 1. 接入微信，验证server是否alive的方法
     * 2. 根据route去分发具体的message
     * @param request
     * @param response
     * @throws Exception
     */
    ...
    public void getTest(HttpServletResponse response) {
        renderString(response, "Server is ok!", "");
    }
